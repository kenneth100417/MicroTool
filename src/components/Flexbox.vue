...
<template>
    <div class="col-md-8" v-if="showFlexboxComponent">
        <div class="text-center mb-5">
            <h3>Flexbox CSS Layout</h3>
        </div>
        ...
        <div class="mt-5">
            <div style="width: 100%; height: 400px;"
                ...
                <div v-for="child in childCount" :key="child"
                    class="p-5 bg-dark text-center d-flex align-items-center justify-content-center fs-1 text-white border border-2 border-warning">
                    {{ child }}
                </div>
            </div>
        </div>
